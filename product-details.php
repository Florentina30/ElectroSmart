...
<div class="sidebar-widget hot-deals wow fadeInUp">
	<h3 class="section-title">Produse Top</h3>
					...
					<div class="products">
						...
						<div class="cart clearfix animate-effect">
							...
							<button class="btn btn-primary" type="button">Adauga in Cos</button></a>
								<?php } else {?>
							<div class="action" style="color:red">Lipsa Stoc</div>
					<?php } ?>
...
<div class="stock-container info-container m-t-10">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-7">
<?php if($row['productAvailability']=='In Stock'){?>
										<a href="product-details.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="btn btn-primary"><i class="fa fa-shopping-cart inner-right-vs"></i> Adauga in Cos</a>
													<?php } else {?>
							<div class="action" style="color:red">Lipsa Stoc</div>
					<?php } ?>
									</div>
